...
public class ToolManagerTests
{
    ...
    #region GetParameterNamesFromSchema Tests

    [Fact]
    public void GetParameterNamesFromSchema_ReturnsEmptyForNullSchema()
    {
        // Act
        var result = _toolManager.GetParameterNamesFromSchema(null);
    ...
    [Fact]
    public void GetParameterNamesFromSchema_ReturnsParameterInfo()
    {
        // Arrange
        var schemaJson = """
        {
        ...
        // Act
        var result = _toolManager.GetParameterNamesFromSchema(schema);

        // Assert
        Assert.Equal(2, result.Count);
        Assert.Equal("string", result["path"].Name);
        Assert.Equal("File path", result["path"].Desc);
        Assert.False(result["path"].Required);
        Assert.Equal("integer", result["count"].Name);
        Assert.Equal("Number of items", result["count"].Desc);
        Assert.False(result["count"].Required);
    }

    [Fact]
    public void GetParameterNamesFromSchema_ReturnsRequiredInfo()
    {
        // Arrange
        var schemaJson = """
        {
        ...
        // Assert
        Assert.True(result["path"].Required);
        Assert.False(result["optional"].Required);
    }

    [Fact]
    public void GetParameterNamesFromSchema_HandlesMissingDescription()
    {
        // Arrange
        var schemaJson = """
        {
        ...
        Assert.Equal("string", result["path"].Name);
        Assert.Equal(string.Empty, result["path"].Desc);
    }

    [Fact]
    public void GetParameterNamesFromSchema_HandlesEmptyRequiredArray()
    {
        // Arrange
        var schemaJson = """
        {
